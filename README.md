    ...
    return `
      <div class="menu-bar" style="width:100%; background-color:#bfbfbf; display:flex; align-items:center; justify-content:space-between; padding:10px 40px;">
        <div style="display:flex; gap:30px;">
          ...
          <a href="#" style="text-decoration:none; color:black;">Feedbacks</a>
          <a href="#" style="text-decoration:none; color:black;">For You</a>
        </div>
    ...
    return `
      <div style="text-align:center; padding:40px; position:relative;">
        ...
        <div style="position:relative; width:100%; height:300px; margin-top:40px;">
          <img src="unnamed.jpg" alt="Left" style="position:absolute; left:90px; top:0; width:300px; height:450px; border-radius:10px; object-fit:cover;">
          <img src="unnamed (2).jpg" alt="Center" style="position:absolute; left:50%; top:0; transform:translateX(-50%); width:500px; height:300px; border-radius:10px; object-fit:cover;">
          <img src="unnamed (1).jpg" alt="Right" style="position:absolute; right:90px; top:0; width:300px; height:450px; border-radius:10px; object-fit:cover;">
        </div>
